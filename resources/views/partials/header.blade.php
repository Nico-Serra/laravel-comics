<header>
    ...
    <nav class="nav justify-content-between align-items-center container ">
        ...
        <div class="d-flex">
            <a class="nav-link {{ Route::currentRouteName() === 'home' ? 'nav-active' : '' }}  py-5 text-dark text-uppercase "
                href="/">Homepage</a>
            <a class="nav-link {{ Route::currentRouteName() === 'comics' ? 'nav-active' : '' }} py-5 text-dark text-uppercase"
                href="/comics">Comics</a>
            <a class="nav-link {{ Route::currentRouteName() === 'login' ? 'nav-active' : '' }} py-5 text-dark text-uppercase"
                href="/login">login</a>
        </div>
